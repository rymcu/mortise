...
public class CacheConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        // === 限流相关缓存 ===
        // 限流计数器缓存 - 根据限流时间窗口动态设置
        configurationMap.put("rateLimitCounter", defaultConfig.entryTtl(Duration.ofMinutes(1)));
        ...
        log.info("Redis缓存管理器初始化完成，配置了 {} 个缓存策略", configurationMap.size());
    ...
    private Jackson2JsonRedisSerializer<Object> createJacksonSerializer() {
        ...
        // 使用构造函数传递ObjectMapper，避免过时的setObjectMapper方法

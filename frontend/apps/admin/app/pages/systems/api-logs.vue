      ...
      <UCard>
        ...
        <div class="mb-4 flex flex-wrap items-center gap-2">
          ...
          <UInput
            ...
            placeholder="结束日期"
          />
          <UButton icon="i-lucide-search" @click="loadLogs">查询</UButton>
          <UButton color="neutral" variant="soft" icon="i-lucide-refresh-cw" :loading="loading" @click="loadLogs">
            刷新
          </UButton>
        </div>
        ...
        <div class="mt-4 flex items-center justify-between text-sm text-muted">
          ...
          <div class="flex items-center gap-2">
            <UButton size="xs" color="neutral" variant="soft" :disabled="!hasPrevious" icon="i-lucide-chevron-left" @click="pageNum--" />
            <span>{{ pageNum }} / {{ totalPage || 1 }}</span>
            <UButton size="xs" color="neutral" variant="soft" :disabled="!hasNext" icon="i-lucide-chevron-right" @click="pageNum++" />
          </div>
        </div>
      </UCard>

      <!-- 详情 Slideover -->
      <ApiLogsDetailSlideover v-model:open="showDetail" :current-log="currentLog" />

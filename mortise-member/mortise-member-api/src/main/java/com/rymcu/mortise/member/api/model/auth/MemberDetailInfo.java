package com.rymcu.mortise.member.api.model.auth;
 ...
 */
public class MemberDetailInfo implements UserDetails, CurrentUser {
     ...
     */
    public MemberDetailInfo(Member member, Collection<? extends GrantedAuthority> authorities) {
        this.id = member.getId();
        this.username = member.getUsername();
        this.password = member.getPasswordHash();
        this.state = member.getStatus();

...
public class Oauth2ClientConfigController {
	...
	@PostMapping
	public GlobalResult<Boolean> create(@Parameter(description = "客户端配置", required = true) @RequestBody Oauth2ClientConfig config) {
	...
	@PutMapping("/{id}")
	public GlobalResult<Boolean> update(@Parameter(description = "配置ID", required = true) @PathVariable Long id,

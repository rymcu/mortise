...
SELECT 300000000000000001, 'AI 配置', 'agent', 'i-lucide-bot', '/agent', 0, 0, 1, 8, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
SELECT 300000000000000011, 'AI 提供商', 'agent:provider', 'i-lucide-server', '/agent/providers', 0, 0, 1, 1, parent.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
-- ========== 三级按钮权限: 提供商 ==========
INSERT INTO mortise.mortise_menu (id, label, permission, icon, href, status, del_flag, menu_type, sort_no, parent_id, created_time, updated_time)
SELECT 300000000000000021, '查询提供商', 'agent:provider:list', 'i-lucide-list', '', 0, 0, 2, 1, parent.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
INSERT INTO mortise.mortise_menu (id, label, permission, icon, href, status, del_flag, menu_type, sort_no, parent_id, created_time, updated_time)
SELECT 300000000000000022, '查看提供商', 'agent:provider:query', 'i-lucide-eye', '', 0, 0, 2, 2, parent.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM mortise.mortise_menu parent WHERE parent.permission = 'agent:provider'
AND NOT EXISTS (SELECT 1 FROM mortise.mortise_menu WHERE permission = 'agent:provider:query');

INSERT INTO mortise.mortise_menu (id, label, permission, icon, href, status, del_flag, menu_type, sort_no, parent_id, created_time, updated_time)
SELECT 300000000000000023, '新增提供商', 'agent:provider:add', 'i-lucide-plus', '', 0, 0, 2, 3, parent.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM mortise.mortise_menu parent WHERE parent.permission = 'agent:provider'
AND NOT EXISTS (SELECT 1 FROM mortise.mortise_menu WHERE permission = 'agent:provider:add');

INSERT INTO mortise.mortise_menu (id, label, permission, icon, href, status, del_flag, menu_type, sort_no, parent_id, created_time, updated_time)
SELECT 300000000000000024, '编辑提供商', 'agent:provider:edit', 'i-lucide-pencil', '', 0, 0, 2, 4, parent.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM mortise.mortise_menu parent WHERE parent.permission = 'agent:provider'
AND NOT EXISTS (SELECT 1 FROM mortise.mortise_menu WHERE permission = 'agent:provider:edit');

INSERT INTO mortise.mortise_menu (id, label, permission, icon, href, status, del_flag, menu_type, sort_no, parent_id, created_time, updated_time)
SELECT 300000000000000025, '删除提供商', 'agent:provider:delete', 'i-lucide-trash', '', 0, 0, 2, 5, parent.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM mortise.mortise_menu parent WHERE parent.permission = 'agent:provider'
AND NOT EXISTS (SELECT 1 FROM mortise.mortise_menu WHERE permission = 'agent:provider:delete');

-- ========== 二级菜单: AI 模型管理 ==========
INSERT INTO mortise.mortise_menu (id, label, permission, icon, href, status, del_flag, menu_type, sort_no, parent_id, created_time, updated_time)
SELECT 300000000000000012, 'AI 模型', 'agent:model', 'i-lucide-brain', '/agent/models', 0, 0, 1, 2, parent.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM mortise.mortise_menu parent WHERE parent.permission = 'agent'
AND NOT EXISTS (SELECT 1 FROM mortise.mortise_menu WHERE permission = 'agent:model');

-- ========== 三级按钮权限: 模型 ==========
INSERT INTO mortise.mortise_menu (id, label, permission, icon, href, status, del_flag, menu_type, sort_no, parent_id, created_time, updated_time)
SELECT 300000000000000031, '查询模型', 'agent:model:list', 'i-lucide-list', '', 0, 0, 2, 1, parent.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
INSERT INTO mortise.mortise_menu (id, label, permission, icon, href, status, del_flag, menu_type, sort_no, parent_id, created_time, updated_time)
SELECT 300000000000000032, '查看模型', 'agent:model:query', 'i-lucide-eye', '', 0, 0, 2, 2, parent.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM mortise.mortise_menu parent WHERE parent.permission = 'agent:model'
AND NOT EXISTS (SELECT 1 FROM mortise.mortise_menu WHERE permission = 'agent:model:query');

INSERT INTO mortise.mortise_menu (id, label, permission, icon, href, status, del_flag, menu_type, sort_no, parent_id, created_time, updated_time)
SELECT 300000000000000033, '新增模型', 'agent:model:add', 'i-lucide-plus', '', 0, 0, 2, 3, parent.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM mortise.mortise_menu parent WHERE parent.permission = 'agent:model'
AND NOT EXISTS (SELECT 1 FROM mortise.mortise_menu WHERE permission = 'agent:model:add');

INSERT INTO mortise.mortise_menu (id, label, permission, icon, href, status, del_flag, menu_type, sort_no, parent_id, created_time, updated_time)
SELECT 300000000000000034, '编辑模型', 'agent:model:edit', 'i-lucide-pencil', '', 0, 0, 2, 4, parent.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM mortise.mortise_menu parent WHERE parent.permission = 'agent:model'
AND NOT EXISTS (SELECT 1 FROM mortise.mortise_menu WHERE permission = 'agent:model:edit');

INSERT INTO mortise.mortise_menu (id, label, permission, icon, href, status, del_flag, menu_type, sort_no, parent_id, created_time, updated_time)
SELECT 300000000000000035, '删除模型', 'agent:model:delete', 'i-lucide-trash', '', 0, 0, 2, 5, parent.id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM mortise.mortise_menu parent WHERE parent.permission = 'agent:model'

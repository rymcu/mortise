...
### 2️⃣ mortise-web-support（Web 层监控）
...
┌─────────────────────┐
│  mortise-web-support │  ← 监控 Web 业务（限流、请求统计）
│  + RateLimiterHealth │
└─────────────────────┘
...
| [cache-expiration-spi-guide.md](../caching/cache-expiration-spi-guide.md) | 缓存失效 SPI 机制使用指南 |
...
### 业务监控
- [x] Resilience4jRateLimiterHealthIndicator - Web 层限流监控（mortise-web-support）
...
- [x] mortise-web-support 添加可选的 actuator 依赖

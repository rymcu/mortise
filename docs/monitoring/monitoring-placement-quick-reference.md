...
| API 限流状态 | `mortise-web-support` | 限流功能在此模块 |
| 请求统计 | `mortise-web-support` | Web 功能在此模块 |
...
**答案**：✅ 在 `mortise-web-support` 模块中创建 `Resilience4jRateLimiterHealthIndicator`
**原因**：
- 限流逻辑（`RateLimitAspect`）在 `mortise-web-support` 模块

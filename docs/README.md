...
- [quickstart/AI_ASSISTED_DEVELOPMENT.md](quickstart/AI_ASSISTED_DEVELOPMENT.md) — Copilot Chat / CLI 中自定义指令与 prompt 的使用方法
...
- [architecture/aiot-ota-module-architecture.md](architecture/aiot-ota-module-architecture.md) — AIoT 与 OTA 模块架构、核心表设计、API 清单、物模型归属
...
- [database/FLYWAY_PERMISSION_FIX.md](database/FLYWAY_PERMISSION_FIX.md)
